  ...
  return (
    <section className='flex md:flex-row flex-wrap my-12 '>
            ...
            <div className='flex-1 flex flex-col justify-around gap-6 min-h-fit mx-6'>
                ...
                <Image src={Facebook} style={{width:'512px', height:'128'}} className=' ml-6 w-full h-full' alt='Phone' />
                ...
                <Button leftIcon={<FaFacebookSquare className='text-blue-600' />} className='bg-white border rounded-3xl text-black font-Inknut font-semibold text-xl w-64 p-4'>
                    Follow us 
                </Button>
            </div>
    </section>
